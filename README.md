...
In my Master Thesis I implemented Machine Learning based approaches to identify non-obvious relationships between clinical and biological features in Chronic Lymphocytic Leukemia (CLL). This thesis was carried out in collaboration with a Physician from the Department of Experimental Medicine at the University of Genoa. This collaboration allowed me to interact with professional figures with a background different from my own, teaching me to convey technical concepts and complex ones, even to non-experts, in a simple and concise way. Moreover, I had the opportunity to autonomously explore a new subject and to develop data analysis skills in a data poor context. Specifically, the proposed Data Analysis and Machine Learning pipeline successfully stratifies CLL patients in homogeneous groups, revealing non-obvious relationships among features and identifying potential markers of differential in vivo stimulation that could be used,in the future, for the development of personalized treatments.
...
My Thesis work paved the way for the writing of a publication, currently in preparation. 
